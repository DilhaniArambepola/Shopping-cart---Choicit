    ...
    <?php include 'template/sidebar.php'; ?>
      <div class="main-content">
            <!-- main-content-->
                    <h1>
                        Baby Frocks<br>
                        <small>You can choose pretty frocks for your cute baby..</small>
                    </h1>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT gFrock_ID,gFrock_name,Selling_price,prod_img,prod_Description FROM baby_gfrocks;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Babies/frocks/<?php echo $row['prod_img']; ?>"></td>
