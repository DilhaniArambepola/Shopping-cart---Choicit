    ...
    <?php include 'template/sidebar.php'; ?>
      <div class="main-content">
            <!-- main-content-->
                    <h1>
                        Short Skirts<br>
                        <small>You can choose your sweet short skirt from here..</small>
                    </h1>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT SSkirt_ID,SSkirt_name,Selling_price,Prod_img,Prod_Description FROM short_skirt;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Short skirt/<?php echo $row['Prod_img']; ?>"></td>
