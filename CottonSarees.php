      ...
      <div class="main-content">
            <!-- main-content-->
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT cSaree_ID,cSaree_name,Selling_price,Prod_img,Prod_Description FROM cotton_sarees;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Cotton Sarees/<?php echo $row['Prod_img']; ?>"></td>
                                    <td><?php echo $row['cSaree_name']  ?></td>
