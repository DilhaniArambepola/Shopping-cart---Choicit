...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT gFrock_ID,gFrock_name,Selling_price,Shipping_cost,prodQty,prod_img,prod_Description "
                . "FROM baby_gfrocks where gFrock_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content-header">
                    <h1>
                        Add Baby Frocks<br>
                        <small>You can add new baby frocks from this form</small>
                    </h1>
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-BabyFrock.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Baby Frock ID</label>  
                                <div class="col-md-4">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdName">Frock Name</label>  
                                <div class="col-md-4">
