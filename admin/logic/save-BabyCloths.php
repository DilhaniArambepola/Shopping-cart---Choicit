...
// if user clicked register button
    ...
    $target_dir = "../../images/Babies/baby boys/";
    ...
    if (isset($_POST['btnSave'])) {
        ...
        $sql = "INSERT INTO `baby_boys` (`boys_ID`,`boys_name`, `Selling_price`, `Shipping_cost`, `prodQty`, `Prod_img`,`Prod_Description`) "
    ...
    if (isset($_POST['btnUpdate'])) {
        // register the user
        //  php source code to EXECUTE INSERT INTO Query
        $sql = "UPDATE `baby_boys` SET `boys_ID`='$pid', `boys_name`='$prodName', `Selling_price`='$price', `Shipping_cost`='$shipping', `prodQty`='$qty', `Prod_Description`= '$description' WHERE `boys_ID`='$pid';";
    }
    

    if ($conn->query($sql) === TRUE) { // successfully added
        header("location: ../add-BabyCloths.php?success");
    } else {
