...
// if user clicked register button
    ...
    $target_dir = "../../images/Babies/Baby Playpen/";
    ...
    if (isset($_POST['btnSave'])) {
        ...
        $sql = "INSERT INTO `playpen` (`playpen_ID`,`playpen_name`, `Selling_price`, `Shipping_cost`, `prodQty`, `Prod_img`,`Prod_Description`) "
    ...
    if (isset($_POST['btnUpdate'])) {
        // register the user
        //  php source code to EXECUTE INSERT INTO Query
        $sql = "UPDATE `playpen` SET `playpen_ID`='$pid', `playpen_name`='$prodName', `Selling_price`='$price', `Shipping_cost`='$shipping', `prodQty`='$qty', `Prod_Description`= '$description' WHERE `playpen_ID`='$pid';";
    }
    

    if ($conn->query($sql) === TRUE) { // successfully added
        header("location: ../add-Playpen.php?success");
    } else {
