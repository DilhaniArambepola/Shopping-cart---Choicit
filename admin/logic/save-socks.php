...
// if user clicked register button
    ...
    $target_dir = "../../images/Babies/baby socks/";
    ...
    if (isset($_POST['btnSave'])) {
        ...
        $sql = "INSERT INTO `baby_socks` (`socks_ID`,`socks_name`, `Selling_price`, `Shipping_cost`, `prodQty`, `Prod_img`,`Prod_Description`) "
    ...
    if (isset($_POST['btnUpdate'])) {
        // register the user
        //  php source code to EXECUTE INSERT INTO Query
        $sql = "UPDATE `baby_socks` SET `socks_ID`='$pid', `socks_name`='$prodName', `Selling_price`='$price', `Shipping_cost`='$shipping', `prodQty`='$qty', `Prod_Description`= '$description' WHERE `socks_ID`='$pid';";
    }
    

    if ($conn->query($sql) === TRUE) { // successfully added
        header("location: ../add-Socks.php?success");
    } else {
