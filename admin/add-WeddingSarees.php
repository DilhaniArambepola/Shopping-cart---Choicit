...
<head>
<meta charset="utf-8">
<title>Add Wedding Sarees</title>
...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT wSaree_ID,wSaree_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM wedding_sarees where wSaree_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content-header">
                    <h1>
                        Add Weding Sarees<br>
                        <small>You can add new accessaries from this form</small>
                    </h1>
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-weddingSarees.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Wedding Saree ID</label>  
                                <div class="col-md-4">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdName">Saree Name</label>  
                                <div class="col-md-4">
