       ...
       <div id="container">
        ...
        <?php include 'templates/sidebar.php'; ?>
            ...
            <div id="content">
                    <h1>
                        View All Frocks<br>
                        <small>You can view all frocks in the store</small>
                    </h1>
                ...
                <!-- Main content -->
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        include '../connection/dbconfig.php';
                         $sql = "SELECT Frock_ID,Frock_name,Selling_price,Shipping_cost,prodQty,Prod_Description,Prod_img FROM frocks;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="add-Frocks.php?id=<?php echo  $row['Frock_ID']; ?>">Edit</a></td>
                                </tr>
                                <?php
                            }
                        } else {
