...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT Frock_ID,Frock_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM frocks where Frock_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content-header">
                    <h1>
                        Add Frocks<br>
                        <small>You can add new frock from this form</small>
                    </h1>
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-frock.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Frock ID</label>  
                                <div class="col-md-4">
