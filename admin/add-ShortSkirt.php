...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT SSkirt_ID,SSkirt_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM short_skirt where SSkirt_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-ShortSkirt.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Short Skirt ID</label>  
                                <div class="col-md-4">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdName">Skirt Name</label>  
                                <div class="col-md-4">
