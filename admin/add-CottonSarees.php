...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT cSaree_ID,cSaree_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM cotton_sarees where cSaree_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content-header">
                    <h1>
                        Add Cotton Sarees<br>
                        <small>You can add new cotton sarees from this form</small>
                    </h1>
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-cottonSarees.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Cotton Saree ID</label>  
                                <div class="col-md-4">
