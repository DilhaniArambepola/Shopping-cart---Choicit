...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT LSkirt_ID,LSkirt_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM long_skirt where LSkirt_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-LongSkirt.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Long Skirt ID</label>  
                                <div class="col-md-4">
