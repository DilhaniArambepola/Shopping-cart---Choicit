...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT Denim_ID, Denim_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM trouser where Denim_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content-header">
                    <h1>
                        Add Denim Trousers<br>
                        <small>You can add new denim trousers from this form</small>
                    </h1>
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-DenimTrouser.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Denim Trouser ID</label>  
                                <div class="col-md-4">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdName">Trouser Name</label>  
                                <div class="col-md-4">
