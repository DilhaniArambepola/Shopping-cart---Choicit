...
<body>
 <?php
    ...
    if (isset($_GET['id'])) {
       ...
       $sql = "SELECT playpen_ID,playpen_name,Selling_price,Shipping_cost,prodQty,Prod_img,Prod_Description "
                . "FROM playpen where playpen_ID='" . $_GET['id'] . "';";
    ...
    ?>
            ...
            <div id="content">
                ...
                <section class="content-header">
                    <h1>
                        Add Playpens<br>
                        <small>You can add new playpens from this form</small>
                    </h1>
                ...
                <section class="content">
                     ...
                     <form class="form-horizontal" method="post" enctype="multipart/form-data" action="logic/save-Playpen.php">
                        <fieldset>
					
                    		 <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdID">Playpen ID</label>  
                                <div class="col-md-4">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtProdName">Playpen Name</label>  
                                <div class="col-md-4">
