    ...
    <?php include 'template/sidebar.php'; ?>
      <div class="main-content">
            <!-- main-content-->
                    <h1>
                        Baby Strollers<br>
                        <small>You can choose your own stroller from Chicit..</small>
                    </h1>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT stroller_ID,stroller_name,Selling_price,Prod_img,Prod_Description FROM strollers;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Babies/strollers/<?php echo $row['Prod_img']; ?>"></td>
                                    <td><?php echo $row['stroller_name']  ?></td>
