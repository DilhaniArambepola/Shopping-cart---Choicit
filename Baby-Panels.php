    ...
    <?php include 'template/sidebar.php'; ?>
      <div class="main-content">
            <!-- main-content-->
                    <h1>
                        Baby Panels<br>
                        <small>You can choose best panels for your cute baby..</small>
                    </h1>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT panel_ID,panel_name,Selling_price,Prod_img,Prod_Description FROM baby_panels;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Babies/baby panel/<?php echo $row['Prod_img']; ?>"></td>
