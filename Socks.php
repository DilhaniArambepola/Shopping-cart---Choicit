    ...
    <?php include 'template/sidebar.php'; ?>
      <div class="main-content">
            <!-- main-content-->
                    <h1>
                        Baby Socks<br>
                        <small>You can choose cute pair of socks for your little baby..</small>
                    </h1>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT socks_ID,socks_name,Selling_price,Prod_img,Prod_Description FROM baby_socks;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Babies/baby socks/<?php echo $row['Prod_img']; ?>"></td>
