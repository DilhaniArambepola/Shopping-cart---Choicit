    ...
    <?php include 'template/sidebar.php'; ?>
      <div class="main-content">
            <!-- main-content-->
                    <h1>
                        Office Wares<br>
                        <small>You can choose your proffesional office ware from here..</small>
                    </h1>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        $sql = "SELECT Office_ware_ID,Office_Ware_name,Selling_price,Prod_img,Prod_Description FROM office_wares;";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ?>
                                <tr>
                                    <td><img class="view-img" src="images/Office wares/<?php echo $row['Prod_img']; ?>"></td>
